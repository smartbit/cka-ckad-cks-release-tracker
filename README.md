...
~ Predicted: K8s GA + 69d avg (last 4), nearest Tue<br>
...
| 1.36 | 2026-04-22  | ~2026-06-23 | ~Tue |  ~62 | ~12   |
...
⁴ v1.32 curriculum revised 2025-05-19: Removed: Choose and use the right workload resource (Development, DaemonSet, CronJob, etc.) · Removed: Understand API deprecations · Removed: Understand Application (SecurityContexts, Capabilities, etc.) · Removed: Understanding requests, limits, and quotas · Added: Choose and use the right workload resource (Deployment, DaemonSet, CronJob, etc.) · Added: Understand API depreciations · Added: Understand Application Security (SecurityContexts, Capabilities, etc.) · Added: Understand requests, limits, quotas
